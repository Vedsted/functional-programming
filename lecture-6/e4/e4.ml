(*
    Study another QuickCheck framework of your choice (JavaScript, Python, C++, Scala, F#, Erlang, Haskell, ...).
    ...
    Now:
        ...
        Does it have a state machine framework for model-based testing? If so: how easy is it/how well does it work?
